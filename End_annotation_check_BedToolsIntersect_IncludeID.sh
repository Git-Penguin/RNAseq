...
awk -v WINDOW_MARGIN=$WINDOW_MARGIN '
{if($4>WINDOW_MARGIN){print $1,$4-WINDOW_MARGIN,$4+WINDOW_MARGIN,"NA","NA",$7}
...
awk -v WINDOW_MARGIN=$WINDOW_MARGIN '{print $1,$5-WINDOW_MARGIN,$5+WINDOW_MARGIN,"NA","NA",$7}' $TRANSCR_ENDS | sort -g -k2 | uniq > MAPPED_3ENDS.bed
...
qecho "out of the total " $TOTAL_5END " 5' ends"   >> IntersectLog.txt
