...
bedtools intersect -s -wao -a MAPPED_5ENDS.bed -b CAGE_5ENDS.bed > Intersect_5END_with_overlap
...
bedtools intersect -s -wao -a MAPPED_3ENDS.bed -b POLYA_3ENDS.bed > Intersect_3END_with_overlap
